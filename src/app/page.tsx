...
import SimplePhenotypeBuilder from "@/app/ui/SimplePhenotype";
      ...
      <div id="accordion-open" data-accordion="open">
        ...
        >
          <div className="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
            <p className="mb-2 text-gray-600 dark:text-gray-400">
              To get started, select a cohort from the buttons below. Then
              define the phenotype that interests you by clicking the "+" button
              and selecting the type of node you want to add.
            </p>
            <p className="mb-2 text-gray-600 dark:text-gray-400">
              As an example, suppose we are interested hypertensive diabetes
              (diabetes and hypertension). To build this phenotype, we would
              select first the "AND" operator, then add both diabetes (E11) and
              hypertension (I10) as children.
            </p>
            <p className="mb-2 text-gray-600 dark:text-gray-400">
            ...
            <p className="mb-2 text-gray-600 dark:text-gray-400">
              ...
              server will then start the GWAS calculation and display the status
              of the job. Once complete, a download link to your results will
              appear.
            </p>
          </div>
        </div>
