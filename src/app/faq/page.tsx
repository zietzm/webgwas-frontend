  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-indigo">
        ...
        <p>A phenotype is an observable characteristic of an individual that results from the interaction of genetic variants and environmental factors. It is a way to describe the phenotypic expression of a trait or disease, and it can be used to identify genetic variants that are associated with a particular trait or disease. In observational studies, the definition of a phenotype is important, and is often made up of fields from electronic health records, measurements, or other observations.</p>
        <br />
